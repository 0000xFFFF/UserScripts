...
| * | [1px video progress bar](https://github.com/0xC0LD/UserScripts/raw/master/1pxVideoBar.user.js) | Always draw a one pixel video progress bar on the bottom of every video element on page. |
